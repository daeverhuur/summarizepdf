              ...
              <Card className="p-8 md:p-12">
                <div className="prose prose-slate max-w-none">
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-slate-700 leading-relaxed mb-2">We collect information that you provide directly to us, including:</p>
                    ...
                    <p className="text-slate-700 leading-relaxed mb-2">When you use the Service, we automatically collect certain information, including:</p>
                    <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4 mb-4">
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-slate-700 leading-relaxed mb-2">We use the collected information for the following purposes:</p>
                  ...
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-slate-900 mb-4">4. Data Processing and AI</h2>
                    <p className="text-slate-700 leading-relaxed mb-4">
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-slate-700 leading-relaxed mb-2">We may share your information in the following circumstances:</p>
                    <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4">
                      <li><strong className="text-slate-900">Service Providers:</strong> With third-party vendors who perform services on our behalf (e.g., Google for AI processing, Stripe for payments, hosting providers)</li>
                      <li><strong className="text-slate-900">Legal Requirements:</strong> When required by law or to respond to legal process</li>
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-slate-700 leading-relaxed mb-2">You have certain rights regarding your personal information:</p>
                    <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4">
                      <li><strong className="text-slate-900">Access:</strong> Request access to your personal information</li>
                      <li><strong className="text-slate-900">Correction:</strong> Request correction of inaccurate information</li>
                      <li><strong className="text-slate-900">Deletion:</strong> Request deletion of your information</li>
                      <li><strong className="text-slate-900">Portability:</strong> Request a copy of your data in a portable format</li>
                      <li><strong className="text-slate-900">Objection:</strong> Object to certain processing of your information</li>
                      <li><strong className="text-slate-900">Withdraw Consent:</strong> Withdraw consent where processing is based on consent</li>
                    </ul>
                    <p className="text-slate-700 leading-relaxed mt-4">
