              ...
              <Card className="p-8 md:p-12">
                <div className="prose prose-slate max-w-none">
                  ...
                  <section className="mb-8">
                    ...
                    <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-4">2.1 Essential Cookies</h3>
                    <p className="text-slate-700 leading-relaxed mb-4">
                    ...
                    <div className="bg-slate-100 border border-slate-200 rounded-lg p-4 mb-4">
                      <p className="text-slate-600 text-sm"><strong className="text-slate-900">Examples:</strong> Session cookies, authentication tokens, security cookies</p>
                    </div>

                    <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-4">2.2 Functional Cookies</h3>
                    <p className="text-slate-700 leading-relaxed mb-4">
                    ...
                    <div className="bg-slate-100 border border-slate-200 rounded-lg p-4 mb-4">
                      <p className="text-slate-600 text-sm"><strong className="text-slate-900">Examples:</strong> User preferences, language settings, theme preferences</p>
                    </div>

                    <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-4">2.3 Analytics Cookies</h3>
                    <p className="text-slate-700 leading-relaxed mb-4">
                    ...
                    <div className="bg-slate-100 border border-slate-200 rounded-lg p-4 mb-4">
                      <p className="text-slate-600 text-sm"><strong className="text-slate-900">Examples:</strong> Google Analytics, usage statistics, page view tracking</p>
                    </div>

                    <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-4">2.4 Marketing Cookies</h3>
                    <p className="text-slate-700 leading-relaxed mb-4">
                    ...
                    <div className="bg-slate-100 border border-slate-200 rounded-lg p-4">
                      <p className="text-slate-600 text-sm"><strong className="text-slate-900">Examples:</strong> Advertising cookies, retargeting pixels, conversion tracking</p>
                    </div>
                  </section>
                  ...
                  <section className="mb-8">
                    ...
                    <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4">
                      <li><strong className="text-slate-900">Google Analytics:</strong> To analyze website traffic and user behavior</li>
                      <li><strong className="text-slate-900">Stripe:</strong> For secure payment processing</li>
                      <li><strong className="text-slate-900">Clerk:</strong> For authentication and user management</li>
                      <li><strong className="text-slate-900">Convex:</strong> For backend database and real-time functionality</li>
                    </ul>
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-slate-700 leading-relaxed mb-2">We use cookies for the following purposes:</p>
                    <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4">
                  ...
                  <section className="mb-8">
                    ...
                    <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-4">5.1 Browser Settings</h3>
                    <p className="text-slate-700 leading-relaxed mb-4">
                    ...
                    <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-4">5.2 How to Manage Cookies in Common Browsers</h3>
                    <ul className="list-disc list-inside text-white/70 space-y-2 ml-4 mb-4">
                      ...
                      <li><strong className="text-slate-900">Firefox:</strong> Settings → Privacy & Security → Cookies and Site Data</li>
                      <li><strong className="text-slate-900">Safari:</strong> Preferences → Privacy → Manage Website Data</li>
                      <li><strong className="text-slate-900">Edge:</strong> Settings → Cookies and site permissions → Cookies and site data</li>
                    </ul>

                    <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-4">5.3 Opt-Out Links</h3>
                    <p className="text-slate-700 leading-relaxed mb-4">
                      You can opt out of certain third-party cookies:
                    </p>
                    <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4">
                      <li><strong className="text-slate-900">Google Analytics:</strong> <a href="https://tools.google.com/dlpage/gaoptout" className="text-[#009de0] hover:text-[#00d4ff]">Google Analytics Opt-out Browser Add-on</a></li>
                    </ul>
                  </section>
                  ...
                  <section className="mb-8">
                    ...
                    <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4">
                      <li><strong className="text-slate-900">Session Cookies:</strong> These are temporary and are deleted when you close your browser</li>
                      <li><strong className="text-slate-900">Persistent Cookies:</strong> These remain on your device until they expire or you delete them. They help us recognize you when you return to the Service</li>
                    </ul>
                  </section>
                  ...
                  <section className="mb-0">
                    ...
                    <div className="bg-slate-100 border border-slate-200 rounded-lg p-6">
                      <p className="text-slate-700">
                        <strong className="text-slate-900">Email:</strong> privacy@summarizepdf.com
                      </p>
                    </div>
                  </section>
