              ...
              <Card className="p-8 md:p-12">
                <div className="prose prose-invert max-w-none">
                  ...
                  <section className="mb-8">
                    ...
                    <h3 className="text-xl font-semibold text-white mb-3 mt-4">3.1 Account Creation</h3>
                    <p className="text-white/70 leading-relaxed mb-4">
                  ...
                  <section className="mb-8">
                    ...
                    <p className="text-white/70 leading-relaxed mb-2">You agree not to use the Service to:</p>
                    <ul className="list-disc list-inside text-white/70 space-y-2 ml-4">
                  ...
                  <section className="mb-8">
                    ...
                    <h3 className="text-xl font-semibold text-white mb-3 mt-4">5.1 Your Content</h3>
                    <p className="text-white/70 leading-relaxed mb-4">
                    ...
                    <h3 className="text-xl font-semibold text-white mb-3 mt-4">5.2 Our Intellectual Property</h3>
                    <p className="text-white/70 leading-relaxed mb-4">
                    ...
                    <h3 className="text-xl font-semibold text-white mb-3 mt-4">5.3 Generated Summaries</h3>
                    <p className="text-white/70 leading-relaxed">
                  ...
                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-white mb-4">6. Payment and Subscriptions</h2>
                    
                    <h3 className="text-xl font-semibold text-white mb-3 mt-4">6.1 Pricing</h3>
                    <p className="text-white/70 leading-relaxed mb-4">
                    ...
                    <h3 className="text-xl font-semibold text-white mb-3 mt-4">6.2 Billing</h3>
                    <p className="text-white/70 leading-relaxed mb-4">
                    ...
                    <h3 className="text-xl font-semibold text-white mb-3 mt-4">6.3 Changes to Pricing</h3>
                    <p className="text-white/70 leading-relaxed">
                  ...
                  <section className="mb-8">
                    ...
                    <h3 className="text-xl font-semibold text-white mb-3 mt-4">7.1 Service Availability</h3>
                    <p className="text-white/70 leading-relaxed mb-4">
                    ...
                    <h3 className="text-xl font-semibold text-white mb-3 mt-4">7.2 AI-Generated Content</h3>
                    <p className="text-white/70 leading-relaxed mb-4">
                    ...
                    <h3 className="text-xl font-semibold text-white mb-3 mt-4">7.3 Limitation of Liability</h3>
                    <p className="text-white/70 leading-relaxed">
                  ...
                  <section className="mb-0">
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-lg p-6">
                      <p className="text-white/70">
                        <strong className="text-white">Email:</strong> legal@summarizepdf.com
                      </p>
                    </div>
                  </section>
