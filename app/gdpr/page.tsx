                ...
                <div className="prose prose-invert max-w-none">
                  ...
                  <section className="mb-8">
                    ...
                    <ul className="list-disc list-inside text-white/70 space-y-2 ml-4">
                      <li><strong className="text-white">Consent:</strong> You have given clear consent for us to process your personal data for specific purposes</li>
                      <li><strong className="text-white">Contract:</strong> Processing is necessary to fulfill a contract with you</li>
                      <li><strong className="text-white">Legal Obligation:</strong> Processing is necessary to comply with the law</li>
                      <li><strong className="text-white">Legitimate Interests:</strong> Processing is necessary for our legitimate interests or those of a third party, unless your interests override</li>
                    </ul>
                  </section>

                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-white mb-4">3. Your Rights Under GDPR</h2>
                    <p className="text-white/70 leading-relaxed mb-4">
                      Under GDPR, you have the following rights regarding your personal data:
                    </p>

                    <h3 className="text-xl font-semibold text-white mb-3 mt-4">3.1 Right to Access</h3>
                    <p className="text-white/70 leading-relaxed mb-4">
                      You have the right to request copies of your personal data. We may charge a small fee for this service.
                    </p>

                    <h3 className="text-xl font-semibold text-white mb-3 mt-4">3.2 Right to Rectification</h3>
                    <p className="text-white/70 leading-relaxed mb-4">
                      You have the right to request that we correct any information you believe is inaccurate or complete information you believe is incomplete.
                    </p>

                    <h3 className="text-xl font-semibold text-white mb-3 mt-4">3.3 Right to Erasure</h3>
                    <p className="text-white/70 leading-relaxed mb-4">
                    ...
                    <h3 className="text-xl font-semibold text-white mb-3 mt-4">3.4 Right to Restrict Processing</h3>
                    <p className="text-white/70 leading-relaxed mb-4">
                      You have the right to request that we restrict the processing of your personal data, under certain conditions.
                    </p>

                    <h3 className="text-xl font-semibold text-white mb-3 mt-4">3.5 Right to Data Portability</h3>
                    <p className="text-white/70 leading-relaxed mb-4">
                      You have the right to request that we transfer the data we have collected to another organization, or directly to you, under certain conditions.
                    </p>

                    <h3 className="text-xl font-semibold text-white mb-3 mt-4">3.6 Right to Object</h3>
                    <p className="text-white/70 leading-relaxed mb-4">
                      You have the right to object to our processing of your personal data, under certain conditions.
                    </p>

                    <h3 className="text-xl font-semibold text-white mb-3 mt-4">3.7 Rights Related to Automated Decision Making</h3>
                    <p className="text-white/70 leading-relaxed">
                  ...
                  <section className="mb-8">
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-lg p-6">
                      <p className="text-white/70 mb-2">
                        <strong className="text-white">Required Information:</strong> When submitting a request, please provide:
                      </p>
                  ...
                  <section className="mb-8">
                    ...
                    <ul className="list-disc list-inside text-white/70 space-y-2 ml-4">
                      <li><strong className="text-white">Identity Data:</strong> Name, username, and account identifiers</li>
                      <li><strong className="text-white">Contact Data:</strong> Email address</li>
                      <li><strong className="text-white">Financial Data:</strong> Payment card details (processed securely by Stripe)</li>
                      ...
                      <li><strong className="text-white">Content Data:</strong> Documents you upload and generated summaries</li>
                    </ul>
                  </section>

                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-white mb-4">6. Data Processing Activities</h2>
                    <p className="text-white/70 leading-relaxed mb-4">
                      We process your personal data for the following purposes:
                    </p>
                    <div className="space-y-4">
                      <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                        <p className="text-white font-semibold mb-2">Service Provision</p>
                        <p className="text-white/60 text-sm">To provide, maintain, and improve the document summarization service</p>
                        <p className="text-white/50 text-xs mt-2">Legal Basis: Contract Performance, Legitimate Interests</p>
                      </div>
                      <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                        <p className="text-white font-semibold mb-2">Account Management</p>
                        <p className="text-white/60 text-sm">To create and manage your user account and subscriptions</p>
                        <p className="text-white/50 text-xs mt-2">Legal Basis: Contract Performance, Consent</p>
                      </div>
                      <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                        <p className="text-white font-semibold mb-2">Communication</p>
                        <p className="text-white/60 text-sm">To send service-related communications and respond to inquiries</p>
                        <p className="text-white/50 text-xs mt-2">Legal Basis: Contract Performance, Legitimate Interests</p>
                      </div>
                      <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                        <p className="text-white font-semibold mb-2">Analytics & Improvement</p>
                        <p className="text-white/60 text-sm">To analyze usage and improve service quality</p>
                        <p className="text-white/50 text-xs mt-2">Legal Basis: Legitimate Interests, Consent</p>
                      </div>
                    </div>
                  </section>
                  ...
                  <section className="mb-8">
                    ...
                    <ul className="list-disc list-inside text-white/70 space-y-2 ml-4">
                      ...
                      <li><strong className="text-white">Document Data:</strong> Retained until you delete them or close your account</li>
                      <li><strong className="text-white">Payment Records:</strong> Retained for 7 years for tax and accounting purposes</li>
                      <li><strong className="text-white">Usage Logs:</strong> Retained for 12 months for security and analytics</li>
                    </ul>
                  </section>

                  <section className="mb-8">
                    <h2 className="text-2xl font-bold text-white mb-4">8. Data Transfers</h2>
                    <p className="text-white/70 leading-relaxed mb-4">
                  ...
                  <section className="mb-0">
                    ...
                    <div className="bg-white/5 border border-white/10 rounded-lg p-6">
                      ...
                      <p className="text-white/70">
                        <strong className="text-white">Email:</strong> dpo@summarizepdf.com
                      </p>
                      <p className="text-white/70 mt-2">
                        <strong className="text-white">Alternative Contact:</strong> privacy@summarizepdf.com
                      </p>
                    </div>
                  </section>
