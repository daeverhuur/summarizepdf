...
**Return ONLY:**
- Verified model name
- Research file paths (absolute)
- Critical API findings
- Next agent name

**NEVER Return:**
- Full scraped documentation
- Verbose API explanations
- Complete research contents
- Repeated documentation

**Why**: Subagents burn tokens in isolation. Research files are saved - no need to repeat contents.
...
MODEL VERIFIED: [exact-model-name]
PROVIDER: [Google/OpenAI/Anthropic]

CREATED:
- C:\[absolute-path]\research\ai-sdk-docs.md
- C:\[absolute-path]\research\provider-docs.md
- C:\[absolute-path]\research\implementation-guide.md

CRITICAL: [One key finding, e.g., "Model requires streaming: true"]
NEXT: ai-implementor
```
