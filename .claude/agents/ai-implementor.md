...
**Why**: Subagents burn tokens in isolation. Implementation details are in code files.
...
```
AI-IMPLEMENTOR COMPLETE: ✅

MODEL: [exact-model-name]
PROVIDER: [Google/OpenAI/Anthropic]

CREATED:
- C:\[absolute-path]\convex\ai\[feature].ts
- C:\[absolute-path]\convex\ai\[feature2].ts

FEATURES: Usage limits enforced, Streaming enabled
NEXT: stripe-builder
```
